Advanced Sassy Web Recipe (HTML, SASS, and JS)
================================================================================
...
Development:
- A `build` Task that uses `clean`, `optimizeImg`, `buildJs`, `buildHtml`, and `buildSass`.
- A default `all` Task that uses `lint`, `build`, `serve` and `watch`.

Production:
- A `build` Task that uses `clean`, `optimizeImg`, `buildJs`, `buildHtml`, `buildSass`, `critHtml`, `buildSitemap`, and `cleanJs`.
